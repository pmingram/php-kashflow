...
class Kashflow
{
    ...
    public function InsertCustomer($data)
    {
        ...
        $xml = '<custr>';
        $xml .= '<CustomerID><![CDATA[' . (int)$data['CustomerID'] . ']]></CustomerID>';
        $xml .= '<Code><![CDATA[' . (string)$data['Code'] . ']]></Code>';
        $xml .= '<Name><![CDATA[' . (string)$data['Name'] . ']]></Name>';
        $xml .= '<Contact><![CDATA[' . (string)$data['Contact'] . ']]></Contact>';
        $xml .= '<ContactFirstName><![CDATA[' . (string) $data['ContactFirstName'] . ']]></ContactFirstName>';
        $xml .= '<ContactLastName><![CDATA[' . (string) $data['ContactLastName'] . ']]></ContactLastName>';
        $xml .= '<Telephone><![CDATA[' . (string)$data['Telephone'] . ']]></Telephone>';
        $xml .= '<Mobile><![CDATA[' . (string)$data['Mobile'] . ']]></Mobile>';
        $xml .= '<Fax><![CDATA[' . (string)$data['Fax'] . ']]></Fax>';
        $xml .= '<Email><![CDATA[' . (string)$data['Email'] . ']]></Email>';
        $xml .= '<Address1><![CDATA[' . (string)$data['Address1'] . ']]></Address1>';
        $xml .= '<Address2><![CDATA[' . (string)$data['Address2'] . ']]></Address2>';
        $xml .= '<Address3><![CDATA[' . (string)$data['Address3'] . ']]></Address3>';
        $xml .= '<Address4><![CDATA[' . (string)$data['Address4'] . ']]></Address4>';
        $xml .= '<Postcode><![CDATA[' . (string)$data['Postcode'] . ']]></Postcode>';
        $xml .= '<Website><![CDATA[' . (string)$data['Website'] . ']]></Website>';
        $xml .= '<EC><![CDATA[' . (int)$data['EC'] . ']]></EC>';
        $xml .= '<OutsideEC><![CDATA[' . (int)$data['OutsideEC'] . ']]></OutsideEC>';
        $xml .= '<Notes><![CDATA[' . (string)$data['Notes'] . ']]></Notes>';
        $xml .= '<Source><![CDATA[' . (int)$data['Source'] . ']]></Source>';
        $xml .= '<Discount><![CDATA[' . (float)$data['Discount'] . ']]></Discount>';
        $xml .= '<ShowDiscount><![CDATA[' . $data['ShowDiscount'] . ']]></ShowDiscount>';
        $xml .= '<PaymentTerms><![CDATA[' . (int)$data['PaymentTerms'] . ']]></PaymentTerms>';
        $xml .= '<ExtraText1><![CDATA[' . (string)$data['ExtraText1'] . ']]></ExtraText1>';
        $xml .= '<ExtraText2><![CDATA[' . (string)$data['ExtraText2'] . ']]></ExtraText2>';
        $xml .= '<Checkbox1><![CDATA[' . (int)$data['Checkbox1'] . ']]></Checkbox1>';
        $xml .= '<Checkbox2><![CDATA[' . (int)$data['Checkbox2'] . ']]></Checkbox2>';
        $xml .= '<Created><![CDATA[' . (string)$data['Created'] . ']]></Created>';
        $xml .= '<Updated><![CDATA[' . (string)$data['Updated'] . ']]></Updated>';
        $xml .= '<CurrencyID><![CDATA[' . (int)$data['CurrencyID'] . ']]></CurrencyID>';
        $xml .= '</custr>';
